...
?>
        <meta charset="utf-8">
        <title><?php echo $sysconfig['system_name'];?> | Bulk Invoice</title>
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Bulk Invoice</a></li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Bulk Invoice</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card">
                                    <div class="card-body">
										<div class="d-print-none mt-4">
                                            <div class="text-end">
                                                <a href="javascript:window.print()" class="btn btn-primary"><i class="mdi mdi-printer"></i> Bulk Print</a>
												<br><br>
                                            </div>
                                        </div>
<?php								
$qry = $conn->query("SELECT f.*,u.first_name,u.last_name,u.address,u.brg_address,u.ct_address,u.pro_address,u.contact from billings f left join consumer_account u on f.consumer_id = u.consumer_id where f.billing_status = 0");
//$row= $qry->fetch_assoc();
if($qry->num_rows > 0){
...
?>
                                        <!-- Invoice Logo-->
                                        <div class="clearfix">
                                            <center><div class="float-start mb-3">
                                            ...
                                            <div class="col-sm-6 offset-sm-2">
                                                <div class="mt-3 float-sm-end">
													...
													<?php 
																...
																if ($row['date_processed'] > $duedate || $date > $duedate){ 
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="text-sm-end">
													<center><img src="qrcodes/<?php echo $row['id'] ?>.png" alt="" id="cimg" class="img-fluid me-2"></center>
                                                </div>
                                            </div> <!-- end col-->
                                        </div>    
                                        <!-- end row -->        
										...
										<div class="row">
											<div class="col-sm-12">
                                                <div class="float-end mt-3 mt-sm-0">
													...
													<?php 
													$basicp2 = $basicp * $pnlt; 
													$finalp = $basicp + $row['balance'];
													?>
													<p><b>Total: <span class="float-end">₱ <?php echo number_format($finalp, 2, '.', ',') ?><b></p>
													<p><b>Penalty(<?php echo $row['penalty_percent'] ?>%): </b> <span class="float-end">₱ <?php echo number_format($basicp2, 2, '.', ',') ?></span></p>
													<p><b>Total After Due Date: </b> <span class="float-end">₱ <?php $finalp = $basicp + $basicp2 + $row['balance']; echo number_format($finalp, 2, '.', ',') ?></span></p>
                                                </div>
                                            </div> <!-- end col -->
										</div>
										<style>
